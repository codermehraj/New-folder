                  ...
                  children: [
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(
                          0 * fem, 0 * fem, 219.27 * fem, 0.39 * fem),
                      width: 26.94 * fem,
                      height: 10.51 * fem,
                      child: Image.asset(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(
                          0 * fem, 2 * fem, 11.39 * fem, 0 * fem),
                      padding: EdgeInsets.fromLTRB(
                          13.63 * fem, 13.8 * fem, 13.63 * fem, 8.06 * fem),
                      decoration: BoxDecoration(
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(
                          13.63 * fem, 11.79 * fem, 13.63 * fem, 6.93 * fem),
                      decoration: BoxDecoration(
                        border: Border.all(color: Color(0xffc5c5c5)),
                        borderRadius: BorderRadius.circular(7.7897253036 * fem),
                      ),
                ...
                child: Row(
                  ...
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(
                          11.53 * fem, 15.36 * fem, 18.37 * fem, 7.7 * fem),
                      width: 157.74 * fem,
                      height: double.infinity,
                      decoration: BoxDecoration(
                        border: Border.all(color: Color(0xffc5c5c5)),
                        borderRadius:
                            BorderRadius.circular(14.6057348251 * fem),
                      ),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          ...
                          Container(
                            // ellipse1oC7 (5:1512)
                            margin: EdgeInsets.fromLTRB(
                                11 * fem, 0 * fem, 0 * fem, 5.15 * fem),
                            width: 116.85 * fem,
                            height: 116.85 * fem,
                            decoration: BoxDecoration(
                              borderRadius:
                                  BorderRadius.circular(58.4229393005 * fem),
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(
                                        14.6057348251 * fem),
                                    border:
                                        Border.all(color: Color(0xffc5c5c5)),
                                  ),
                                ),
                              ),
                            ),

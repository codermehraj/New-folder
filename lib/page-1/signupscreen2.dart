          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                ...
                padding: EdgeInsets.fromLTRB(24*fem, 33*fem, 23*fem, 74*fem),
                width: double.infinity,
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Container(
                      // logo2Som (112:1854)
                      margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 14*fem, 16.5*fem),
                      width: 104*fem,
                      height: 100*fem,
                      child: Image.asset(
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(8*fem, 0*fem, 0*fem, 36.5*fem),
                      child: Text(
                        'Finish Sign up',
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(101*fem, 0*fem, 102*fem, 18*fem),
                      width: double.infinity,
                      height: 125*fem,
                      decoration: BoxDecoration (
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.fromLTRB(90*fem, 0*fem, 90*fem, 24*fem),
                      padding: EdgeInsets.fromLTRB(22*fem, 1*fem, 22*fem, 1*fem),
                      width: double.infinity,
                      height: 38*fem,
                      decoration: BoxDecoration (
                    ...
                    Container(
                      ...
                      child: Container(
                        ...
                        padding: EdgeInsets.fromLTRB(12.81*fem, 10*fem, 60*fem, 10*fem),
                        width: double.infinity,
                        height: 65*fem,
                        decoration: BoxDecoration (
                          color: Color(0xfff3f5f7),
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.fromLTRB(106*fem, 14*fem, 106*fem, 14*fem),
                      width: double.infinity,
                      height: 49*fem,
                      decoration: BoxDecoration (
                        color: Color(0xff9f1f63),
